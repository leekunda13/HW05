...
test -s test-plans/23127035_Soak_20260831.jmx
test -s results/23127035_Soak_20260831.jtl
test -s reports/23127035_Soak_20260831/index.html
xmllint --noout test-plans/23127035_Soak_20260831.jmx
...
for scenario in ("Load", "Stress", "Spike", "Soak"):
    ...
    stem = f"23127035_{scenario}_20260831"
...
with (root / "evidence/resource/23127035_Soak_20260831_run_metadata.csv").open(newline="") as stream:
...
for pdf in output/pdf/main_report.pdf output/pdf/AI_Audit.pdf output/pdf/AI_Critique.pdf; do
  test -s "$pdf"
